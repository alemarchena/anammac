...
<head>
    ...
    <script>var version=30  ;</script>

    <link rel="stylesheet" href="./estilos.css?a=30">
    <link rel="stylesheet" href="./main.css?a=30">

    <script src="./main.js?a=30" type="module"></script>
    <script src="./funciones.js?a=30"></script>
            ...
            <div id="carrusel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                     ...
                     <div class="d-flex justify-content-center">
                                <a id="descargarinscriptos" href="./controladores/descargainscriptos.php?a=30" class="btn btn-success btn-lg" >Descargar Inscritos</a>
                        </div>
                        <br>
                        <div class="d-flex justify-content-center">
                            <a id="descargainscriptosppago" href="./controladores/descargainscriptosppago.php?a=30" class="btn btn-warning btn-lg" >Descargar Inscritos sin pago</a>
                        </div>
                        <br>
                        <div class="d-flex justify-content-center">
                                <a id="descargarinscriptos" href="./controladores/descargaafiliadossininscripcion.php?a=30" class="btn btn-info btn-lg" >Descargar Afiliados sin inscribirse</a>
                        </div>
                    </div>
