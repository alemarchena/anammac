...
export class UI{
    ...
    Mensajero(contador){
        ...
        {
            case 0:
                contenido = 'Busqueda de datos';
                break;
            case 1:
                contenido = 'Creación de usuarios administradores y delegados';
                break;
            case 2:
                    contenido = 'Descarga un archivo en formato Excel con todos los afiliados';
                    break;
