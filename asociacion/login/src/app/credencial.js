...
export const Redirigir = ( async (info)=>{
   ...
   let direccion = '/asociacion/administracion/panel.php?a=18';
   ...
   fetch('./controladores/puente.php?a=18',
...
export const RedirigirEventos = ( async (info)=>{
   ...
   // let direccion = '/asociacion/eventos/panel.php?a=18';
   let direccion = '/anammac/asociacion/eventos/panel.php?a=18';
