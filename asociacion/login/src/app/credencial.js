...
export const Redirigir = ( async (info)=>{
   ...
   let direccion = '/asociacion/administracion/panel.php?a=21';
   ...
   fetch('./controladores/puente.php?a=21',
...
export const RedirigirEventos = ( async (info)=>{
   ...
   let direccion = '/asociacion/eventos/panel.php?a=21';
   // let direccion = '/anammac/asociacion/eventos/panel.php?a=21';
