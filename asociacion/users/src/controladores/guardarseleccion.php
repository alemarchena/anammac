<?php
    ...
    $sql = "Insert into $tabla (numeroafiliado,idevento,codigoprueba,codigodetalle,ideventoprueba) values('$numeroafiliado',$idevento,$codigoprueba,$codigodetalle,$ideventoprueba)";
